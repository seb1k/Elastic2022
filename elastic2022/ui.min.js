...
var txt=m.querySelector(".rcmContactAddress").textContent.trim().replace(/[|&;$%@"<>()+-.,]/g, "");
var ret =txt.charAt(0)
var tab = txt.split(' ');
/*
for(var i=1;i<3&&tab.length>i;i++)
    ret+=tab[i].charAt(0)
*/
if(tab[1])
    ret+=tab[1].charAt(0)
...
var lst_cols="C239B3 7A7574 750B1C 4F6BED 5C2E91 0078D4 004E8C CA5010 8E562E 498205 038387 986F0B 0B6A0B 005B70 8764B8";
