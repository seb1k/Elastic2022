...
if(document.querySelector('#i_dont_know_how_to_manage_it') && i_dont_know_how_to_manage_it.querySelector('.button-calendar')) // Calendar plugin
    {
	var txt = i_dont_know_how_to_manage_it.querySelector('.button-calendar').querySelector('span').textContent
	var calendarmenu = 	'<div class="menuopt calendar">'+
		'<a href="./?_task=calendar"><i class="sebicon calendaricon" style="display: inline-block;width: 40px;"></i>'+txt+'</a>'+
	'</div>'
	
	document.querySelector(".footerseb").querySelector(".contacts").insertAdjacentHTML('afterend', calendarmenu);
    }
...
var menuHTML=""
if(document.querySelector(".footerseb").querySelector(".calendaricon")) // If calendar
	{
	if(rcmail.env.task == "calendar")
		menuHTML += "<div class='menuopt'>"+document.querySelector(".footerseb").querySelector(".mail").innerHTML+"</div>"
	else
		menuHTML += "<div class='menuopt'>"+document.querySelector(".footerseb").querySelector(".calendar").innerHTML+"</div>"
	}
...
if(rcmail.env.task == "mail")		setTimeout(function() { $('#folderlist-content').insertBefore($('.footerseb')); }, 300);
if(rcmail.env.task == "calendar")
	{
	setTimeout(function() { $('#menuleft .searchbar').insertBefore($('.footerseb')); }, 50);
	setTimeout(function() { $('#calendars-content').insertBefore($('.footerseb')); }, 50);
	}
