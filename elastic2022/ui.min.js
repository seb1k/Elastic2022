...
if(rcmail.env.action=="preview")
	...
	if(contactphoto.src.endsWith("contactpic.svg")||contactphoto.src.endsWith("&_error=1"))
		{
...
if(!document.querySelector("#menuleft"))
    {
	var HTMLmenu="<div id='menuleft'><div>&nbsp;</div><div id='menuleft_cont'></div><div id='menuleft_bottom' class='menu' style='margin-top:40px;border-top:1px solid #374549'></div></div>"
